//example, learnt, and taught by nick. use the keyboard to hover over the send to revieve msg instead//
//bit confused with this week exercise//
import oscP5.*;
import netP5.*;
