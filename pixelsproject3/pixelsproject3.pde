//project 3 , you can use the P key to activate a flash light effect//
//you can also click your mouse to reset the pixels and see an outline of eren//
//most coding found in learning proceccing intergrated book//
